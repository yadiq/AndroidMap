...
import com.hqumath.map.net.download.DownloadInterceptor;
import com.hqumath.map.net.download.DownloadListener;
import com.hqumath.map.utils.SSLSocketClient;
